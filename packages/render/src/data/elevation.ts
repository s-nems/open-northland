 ...
 * `TILE_HALF_H/32` px per elevation unit (1.1875 px at the measured 38 px row step; supersedes an
 * earlier photogrammetric fit of ≈1.24). The ground mesh samples nodes exactly (`terrain.ts`
