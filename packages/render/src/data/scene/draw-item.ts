...
export interface DrawItem extends Readonly<StaticDrawFields> {
  ...
  /** An unfinished palisade site. Before a builder plants its work flag it is only a white ground
   *  marker; once planted it reuses the ordinary delivery/work flag art. */
