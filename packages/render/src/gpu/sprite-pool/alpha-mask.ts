 ...
 * to a half-cell and asks the logic layer which house occupies it (research notes
 * `CWorldDisplayElement.an original routine` → `DED_WorldPixelToMapMIGCoordinates` → cell→house
