 ...
 * sub-rect branch of {@link import('./sprite-pool/index.js').SpritePool}) is actually exercised end to
 ...
 * {@link import('../data/sprites/index.js').SpriteKind}) drawn procedurally into a canvas. It is NOT art — it's a
