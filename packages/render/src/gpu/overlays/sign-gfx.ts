 ...
 *
 * A named deviation: the original plants its stand ON the flag point. Magnitude and flat-left direction are
 * pixel judgements a human signs off, not measurements.
 */
