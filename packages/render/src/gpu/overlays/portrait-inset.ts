...
/**
 * The details-panel portrait "observation window" — a live cutout of the world centred on the selected
 * entity, rendered into the panel's box each frame. It owns a SECOND render of the shared
 * {@link Container} `worldLayer` (re-aimed at the unit), run by the {@link
...
export class PortraitInsetLayer {
   ...
   * actual second render happens in {@link draw}, just before the main stage render.
   */
