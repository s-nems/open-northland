 ...
 * decoded map lane dimensions and footprint coordinates; the half-cell anchoring is additionally the
 * best-aligned reading of the maps' `lmlt` blocking lane — see docs/formats/MAPDAT.md).
