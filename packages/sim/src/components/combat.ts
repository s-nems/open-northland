 ...
 *  - `originX`/`originY` - the Position the shot left at the release frame (fixed-point, frozen at launch),
 *    read only by the render, which needs the chord's start to place the shot on its ballistic arc (the
