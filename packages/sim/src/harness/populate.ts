...
import { buildTerrainGraph, type NodeId, TerrainGraph, type TerrainMap } from '../nav/terrain.js';
 ...
 * `.ini`; research notes' sim is a stub), so the even walkable-cell distribution here is a deterministic
