 ...
 * carrier routes them there, and the builder drive
 * ({@link import('../settlers/drives/economy/index.js').planBuilder}) both hammers the site and - when it
 * runs dry - fetches a missing material itself.
 *
