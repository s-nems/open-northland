...
import { experienceBonus, experiencePoints, generalTrackFor } from '../../../../../progression/index.js';
...
export function hunterShotMisses(world: World, ctx: SystemContext, shooter: Entity): boolean {
  ...
  const spread = fx.mul(
    fx.fromInt(HUNTER_MASTER_HIT_PCT - HUNTER_BASE_HIT_PCT),
    experienceBonus(experiencePoints(xp)),
  );
