 ...
 * original binary, unreconstructed by research notes), so the magnitude hangs on the walk-cycle anchor
 ...
 * with no acceleration anywhere (no accel/inertia state exists in research notes or any readable data
