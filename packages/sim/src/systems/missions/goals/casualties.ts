...
/** Holds once nothing stamped with the id is left standing. The three goals differ only in what they
 *  look for, since houses and animals share one object-id kind. */
