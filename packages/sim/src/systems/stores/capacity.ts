...
/** Whether `e` is a heap lying on the ground: a positioned stockpile that is neither a building store nor a
 *  wall's construction stock, whatever marker it carries. A vehicle's hold is `VehicleStock`, never a
