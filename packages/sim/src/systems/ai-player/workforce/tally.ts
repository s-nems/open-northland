...
/** Bound-settler headcount per (building, jobType). A decision plans all its staffing before any of its
 *  commands apply, so it counts its own pending posts against this live tally. */
