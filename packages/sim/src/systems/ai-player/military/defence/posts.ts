...
/**
 * How many archers the seat walls into each tower it raises. A posted man leaves the field army for good
 * ({@link import('../census.js').takeCensus} drops him), so a seat with five soldiers and a standing tower
 * holds its wave back rather than leave the wall silent.
 */
 ...
 * nearest the door first, taken only from classes that tower offers a slot for.
 *
