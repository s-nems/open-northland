 ...
 * column per need, whose maximum row reads 10000 (`GameMp.exe` file offset `0xf0b34`).
 */
 ...
 * copy's `GameMp.exe` drops a settler's work below 2001, tops a bar up at home below 8001, and marks a need
