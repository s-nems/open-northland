...
// (./production.ts), atomicSystem (./atomic.ts), aiSystem (./ai.ts, the settler planner) — and the
// not-yet-implemented stubs (./stubs.ts). The genuinely cross-system helpers live in ./shared.ts.
