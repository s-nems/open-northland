...
import { HUNGER_RISE_PER_TICK, needsSystem } from './needs.js';
...
// needsSystem (./needs.ts, hunger rise) — and the not-yet-implemented stubs (./stubs.ts). The
...
export { HUNGER_RISE_PER_TICK, needsSystem };
