...
import { FATIGUE_RISE_PER_TICK, HUNGER_RISE_PER_TICK, needsSystem } from './needs.js';
...
// needsSystem (./needs.ts, hunger + fatigue rise) — and the not-yet-implemented stubs (./stubs.ts). The
...
export { FATIGUE_RISE_PER_TICK, HUNGER_RISE_PER_TICK, needsSystem };
