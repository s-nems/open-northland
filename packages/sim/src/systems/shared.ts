import type { ArmorType, ContentSet, ProductionInput, Recipe, WeaponType } from '@vinland/data';
 ...
 * {@link WeaponType} against every {@link ArmorType} class (plus the unarmored class `0`), resolving
