...
export const COW = 13; // last-resort livestock prey (huntPrey lastResort, fully passive - not aggressive, not getAngry)
export const DEER = 14; // normal-game-and-PROVOKABLE prey tribe (huntPrey + getAngry; angryGameTime 10; test_antler)
