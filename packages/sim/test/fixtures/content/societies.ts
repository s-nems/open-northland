export const societyContent = {
  ...
  animals: [
    ...
    // animal that sets both has `runspeed < movespeed` — stamped as the MoveSpeed's `runPerTick`, which
    // movement reads whenever an entity flees; no animal drive selects that mode yet.
    {
      id: 'bear',
      tribeType: 10,
      aggressive: true,
