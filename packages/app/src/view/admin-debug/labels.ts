...
import { type GoodEntry, PLAYER_SWATCHES, RESOURCE_ENTRIES, type UnitPreset } from './spawn-catalog.js';
...
export function createAdminLabels(
  ...
  return { good: localizedGood, unit: unitLabel, action: actionLabel, player: playerName, status };
}
