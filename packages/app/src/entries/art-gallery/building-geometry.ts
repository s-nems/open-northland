...
/**
 * One own building's logic geometry as the gallery draws it: anchor node at the origin on an even
...
/** The tribes whose bodies and anchors the gallery resolves: every tribe an own package names, base first. */
