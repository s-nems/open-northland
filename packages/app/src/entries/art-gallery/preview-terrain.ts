...
import { bakeOwnMaterial } from '../../content/own-assets/material-atlas.js';
import {
  MATERIAL_COLUMNS,
  MATERIAL_GUTTER,
  MATERIAL_STRIDE,
  MATERIAL_TILE,
  MATERIAL_TILES,
} from '../../content/own-assets/material-layout.js';
import {
  MOUNTAIN_GUTTER,
  MOUNTAIN_HEIGHT,
  MOUNTAIN_WIDTH,
} from '../../content/own-assets/mountain-layout.js';
...
export async function terrainPreview(
  ...
  const baked = bakeOwnMaterial(renderer, source, soil, entry.manifest);
