 ...
 * extracted scale sets the band — animals are 15000–20000, the HQ 100000, a real sword hits 1600. At 5000 a
 * fighter takes ~3 sword swings, matching the original's many-hits melee. Verify/pin: see the
 * `verify-human-hitpoints` ticket.
 */
