 ...
 * windows — rebuilt from the extracted GUI atlas + fonts at the research notes-pinned geometry (`?scene=tool-panel`).
 *
...
export const toolPanelScene: SceneDefinition = {
  ...
  summary:
    ...
    'przypiętej do research notes (skala 1×, `?uiscale=2|3` powiększa). Przycisk PRĘDKOŚCI cyklicznie zmienia ' +
