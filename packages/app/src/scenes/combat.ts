...
export const combatScene: SceneDefinition = {
  ...
  checklist: [
    ...
    'KREW: gdy cios (miecz/wlocznia/strzala) TRAFIA, pojawia sie mala czerwona strużka we wrogu; zamach W POWIETRZE (cel sie odsunal, brak sasiada) NIE zostawia krwi',
    'KOSCI: po smierci zostaje na ziemi mala kupka kosci w miejscu zgonu (zastepczy szkielet — docelowo zdekodowany kadawer, znana luka); kosci utrzymuja sie dlugo i powoli znikaja',
    'DZWIEK ataku: cios w zwarciu brzmi (uderzenie miecza/wloczni), luk „napina" i strzala „lupie" przy trafieniu (wlacz dzwiek przyciskiem na dole)',
