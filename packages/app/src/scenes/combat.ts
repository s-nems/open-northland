...
export const combatScene: SceneDefinition = {
  ...
  checklist: [
    ...
    'DZWIEK ataku: kazdy zamach w zwarciu „swisza", a trafienie „uderza" (miecz/wlocznia); luk „napina" i strzala „lupie" przy trafieniu (wlacz dzwiek przyciskiem na dole)',
