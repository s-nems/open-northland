 ...
 * shared game view (fog/controls/HUD perspective). `?vacantai=` (free Human seats toggled to
 * auto-play) is menu-authored but has no consumer yet — the future AI player reads it.
 */
