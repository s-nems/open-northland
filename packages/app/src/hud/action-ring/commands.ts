...
export const ACTION_COMMANDS: readonly ActionCommand[] = [
  ...
  { id: 'assignBuildingSite', arm: RIGHT_ARM, icon: 'order_assign_building_site', multi: true },
  { id: 'removeLearningPlace', arm: RIGHT_ARM, icon: 'order_remove_learning_place', multi: true },
