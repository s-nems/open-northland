 ...
 *
 * Every rect below is transcribed verbatim from the research notes reverse-engineering of the original
 * engine — `Source/an original routine/CGuiManager.cs` `Desktop_Open()`, where the toolbar strip and each
 ...
 * Ids follow the checked-in atlas-map names; the research notes analyse labels gfx 0x2f `_btnHelp` (str 1)
