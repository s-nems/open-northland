 ...
 *
 * research notes `CGuiManager.cs` `MiscButtons_SpeedButton_Update()` chooses the button's gfx from the current
 ...
 * click while paused resumes) that remembers the running speed and restores it on unpause. The analyse
