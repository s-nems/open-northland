...
/**
 * Byte evidence: the per-type priority switch of the owned `GameMp.exe` (VA 0x4b29fc) and the owned
 * CulturesNation `Mod.exe` (VA 0x4b3419) select the same three groups; `goodNotFound` alone branches on
 * the settler's trade.
 */
