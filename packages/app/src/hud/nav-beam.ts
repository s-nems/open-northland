...
/**
 * The bottom navigation beam's design-px box (FOUNDATION.md): seven 42 × 48 actions with 2 px gaps on
 * a beam padded 4 / 6 / 2 px. The numbers mirror `.on-beam` and `.on-action` in `dom/foundation.css`.
 */
const NAV_ACTION_W = 42;
const NAV_ACTION_H = 48;
const NAV_ACTION_GAP = 2;
const NAV_ENTRIES = 7;
const NAV_PAD_X = 6;
const NAV_PAD_TOP = 4;
const NAV_PAD_BOTTOM = 2;
