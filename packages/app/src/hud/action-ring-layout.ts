 ...
 * analyse. What is NOT recoverable: which command maps to which group-type and which gfx id (the engine's
 ...
 * the analyse's centring (`start = centre + startSign·(STEP/2)·(N-1)`, then `+ stepSign·STEP·i`); `nudge`
