 ...
 * analyse. What the analyse does NOT recover: which command maps to which gfx id (the engine's
 ...
 * the command→icon binding research notes' unfilled `sHumanCommandTypeToIconId` table could not recover. NOTE
