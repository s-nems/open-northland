 ...
 * choice, not analysed behavior: research notes only loads these bitmaps, their draw sites aren't ported,
 ...
 *  health/need level (eyeballed, not sampled; the original's bar-draw code isn't analysed). */
