 ...
 * that a bar's colour follows its level. How the engine consumes it isn't analysed (`PalBarHitpoints`
 * is loaded in research notes but its draw site isn't ported), so the panel's reading — fill colour =
