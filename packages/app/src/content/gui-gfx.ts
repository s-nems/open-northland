 ...
 * evidence that a bar's colour follows its LEVEL. How the engine consumes them isn't analysed
 * (`PalBarHitpoints` is loaded in research notes but its draw site isn't ported), so the panel's reading —
