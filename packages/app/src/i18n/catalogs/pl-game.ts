export const plGame = {
  ...
  userMessages: {
    ...
    short: {
      ...
      vehicleSiteNotFound: 'Brak placu budowy',
      ...
      noWayToMarry: 'Brak drogi do ślubu',
      ...
      diplomacyChanged: 'Nowe nastawienie',
      playerDied: 'Poza grą',
      specialItemFound: 'Nowy przedmiot',
    },
    shortWithGood: {
      goodNotFound: 'Brak: {good}',
      waitingForGood: 'Czeka na: {good}',
      stockFull: 'Skład pełny: {good}',
      canProduceNewGood: 'Nowy towar: {good}',
      canEquipNewItem: 'Może użyć: {good}',
      producedOneGood: 'Gotowe: {good}',
      couldNotProduceOneGood: 'Nie wyszło: {good}',
    },
    shortWithStance: {
      playerSighted: 'Kontakt: {stance}',
      diplomacyChanged: 'Teraz: {stance}',
    },
    shortUnknownHeroDied: 'Nieznany poległ',
    shortBecameSoldier: 'Żołnierz',
    shortLearnedProfession: 'Zawód: {profession}',
    rows: {
