export const plGame = {
  ...
  hud: {
    ...
    schoolTitle: 'Szkoła',
    schoolHint: 'Wybierz zawód lub metodę produkcji. Zaawansowane metody muszą być odkryte przez osadę.',
    schoolProfession: 'Naucz zawodu',
    schoolUndiscovered: 'Osada jeszcze tego nie odkryła',
    schoolRequiresProfession: 'Najpierw wybierz zawód: {profession}',
    schoolWrongTribe: 'Wybrani osadnicy należą do różnych plemion',
    schoolClose: 'Zamknij',
