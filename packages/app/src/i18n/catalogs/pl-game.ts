export const plGame = {
  ...
  net: {
    ...
    kicked: '{nick}: wyrzucenie, miejsce przejmuje SI',
    kickedIdle: '{nick}: wyrzucenie, miejsce zostaje puste',
    youWereKicked: 'Głosowanie wyrzuciło cię z gry',
    paused: '{nick}: pauza',
    resumed: '{nick}: wznowienie',
    speed: '{nick}: tempo x{speed}',
    memberJoined: '{nick}: dołączenie',
    memberDropped: '{nick}: utrata połączenia',
    memberReturned: '{nick}: powrót',
    desync:
    ...
    roundTrip: 'podróż w obie strony {ms} ms',
    inputDelay: 'opóźnienie wejścia {ticks} kroki ({ms} ms)',
  },
} as const;
