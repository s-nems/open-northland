export const plGame = {
  ...
  hud: {
    ...
    tradeAttachHouseHint:
      'Kliknij, a potem wskaż podświetlony dom. We własnej osadzie kupiec wozi dowolne towary między dwoma domami z zapasami. U innego plemienia handluje tylko w domu, który ma umowę handlową.',
    tradeDetachHouse: 'Zdejmij ten dom z trasy',
    tradeForeignHouse: '{house} (gracz {player})',
    tradeImportHint: 'Przywoź tu: {good}.',
    tradeOffer: 'Oddajesz {giveAmount} {give}, dostajesz {takeAmount} {take}',
    tradeOfferHint:
      'Handluj według tej umowy: kupiec zawozi tam to, co oddajesz, i przywozi to, co dostajesz.',
    tradeCart: 'Wóz',
    ...
    tradeNoAgreement: 'Wybierz umowę powyżej',
