export const enGame = {
  ...
  hud: {
    ...
    choiceSearch: 'Search…',
    choiceEmpty: 'No discovered choices.',
    choiceNoMatches: 'No matching choices.',
    choiceBasic: 'Basic',
    choiceMethods: 'Production method',
    schoolPlaces: 'Places: {occupied} / {capacity}',
    schoolUnavailable: 'These settlers cannot train at this school',
    schoolTitle: 'School',
    ...
    tradeAttachHouseHint:
      'Click, then pick a lit house. In your settlement a trader carts any goods between two houses that keep a stock. With another tribe it trades only at a house that offers a trade agreement.',
    tradeDetachHouse: 'Take this house off the route',
    tradeForeignHouse: '{house} (player {player})',
    tradeImportHint: 'Import {good} here.',
    tradeOffer: 'You give {giveAmount} {give}, you get {takeAmount} {take}',
    tradeOfferHint:
      'Trade on this agreement: the trader takes what you give there and brings back what you get.',
    tradeCart: 'Cart',
    ...
    tradeNoAgreement: 'Pick an agreement above',
