export const enGame = {
  ...
  userMessages: {
    ...
    short: {
      ...
      cannotDamageTarget: 'Cannot harm target',
    ...
    shortWithGood: {
      goodNotFound: 'Missing: {good}',
      waitingForGood: 'Waiting for: {good}',
      stockFull: 'Store full: {good}',
      canProduceNewGood: 'New good: {good}',
      canEquipNewItem: 'Can use: {good}',
      producedOneGood: 'Done: {good}',
      couldNotProduceOneGood: 'Not made: {good}',
    },
    shortWithStance: {
