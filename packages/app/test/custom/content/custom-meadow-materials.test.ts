...
import { z } from 'zod';
import { customMaterialBindings } from '../../../src/custom/content/material-layout.js';
...
describe.runIf(hasRealIr() && existsSync(path))('own meadow on Magiczny Las', () => {
  it('covers the complete sand family without claiming unrelated patterns on its shared page', () => {
    ...
    const bindings = customMaterialBindings(ir.gfxPatterns, ir.gfxPatternTransitions, customTerrainMaterials);
