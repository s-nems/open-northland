 ...
 * building `id`, `kind` and defence flag, and every catalog typeId must have a viking `buildingBobs`
 * row (a bound bob → "graphics in place"). The catalog's pure lookup tests live with the fixture suite
...
describe.runIf(hasRealIr())('viking building catalog vs real IR', () => {
  it('matches ir.json building id, kind and defence flag for every entry', () => {
