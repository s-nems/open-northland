 ...
 * building `id`, `kind`, bio-pattern, collect action and defence flags, and every catalog typeId must have a viking
...
describe.runIf(hasRealIr())('viking building catalog vs real IR', () => {
  it('matches ir.json building id, kind, collect action and placement/defence flags for every entry', () => {
