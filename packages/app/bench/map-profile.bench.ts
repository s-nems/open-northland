...
const PROFILE_TIMEOUT_MS = 3 * 60 * 60_000;

describe('map cpu profile', () => {
  it('reports which functions the measured ticks spend their time in', {
    ...
    expect(summary.sampledMs).toBeGreaterThan(0);
