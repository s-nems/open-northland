...
describe('validateCrossReferences', () => {
  ...
  const REJECT_CASES: { name: string; overrides: Record<string, unknown>; error: RegExp }[] = [
    ...
    {
      name: 'a vehicle yard spawning an unknown vehicle',
      overrides: { buildings: [{ typeId: 46, id: 'catapult', kind: 'vehicle', vehicleType: UNKNOWN }] },
      error: /building "catapult" spawns unknown vehicleType 99/,
    },
    {
      name: 'a vehicle good opening an unknown house',
      overrides: { goods: [{ typeId: 63, id: 'catapult', vehicleHouse: UNKNOWN }] },
      error: /good "catapult" opens unknown vehicle house buildingType 99/,
    },
    {
