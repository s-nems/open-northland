 ...
 *
 * Not ported from research notes (its `.ini` handling is a trivial text parse). The grammar facts come
 ...
 * `cif.ts` (decoded latin1 to match the research notes oracle byte-for-byte). Re-decoding a `.cif`
 ...
 * latin1 to match the research notes oracle and needs {@link latin1ToCp1250} for display).
 */
 ...
 * the readable `houses.ini` records themselves (research notes decodes formats, not house semantics):
