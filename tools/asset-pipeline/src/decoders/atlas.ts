 ...
 * research notes oracle. Index 0 is a real palette colour for bobs (not a reserved colour-key), so alpha
 ...
 *    (`PrintBob_UsingShadedAlpha`, research notes' best-effort reconstruction corroborated by the
