 ...
 *
 * Ported FORMAT (not architecture) from research notes `Source/an original routine/CIoHelper.cs`
 ...
 *
 * APPROXIMATED: the per-corner→per-cell reduction has no behavioral oracle (research notes decodes the
