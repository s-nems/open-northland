...
const GUI_PALETTES_DIR = 'Data/gui/palettes';
/** The speech/thought-bubble palette, which lives outside the element-palette tree. */
const BUBBLES_PALETTE_FILE = 'Data/engine2d/bin/palettes/gui/gui_bubbles.pcx';
...
const GUI_PALETTES: readonly GuiPaletteSource[] = [
  { name: 'iconsleft', file: `${GUI_PALETTES_DIR}/iconsleft.pcx` },
  { name: 'context', file: `${GUI_PALETTES_DIR}/context.pcx` },
  { name: 'frame', file: `${GUI_PALETTES_DIR}/frame.pcx` },
  { name: 'bar_standart', file: `${GUI_PALETTES_DIR}/bar_standart.pcx` },
  { name: 'bar_hitpoints', file: `${GUI_PALETTES_DIR}/bar_hitpoints.pcx` },
  { name: 'bar_disabled', file: `${GUI_PALETTES_DIR}/bar_disabled.pcx` },
  { name: 'bg_normal', file: `${GUI_PALETTES_DIR}/bg_normal.pcx` },
  { name: 'bg_hilite', file: `${GUI_PALETTES_DIR}/bg_hilite.pcx` },
  { name: 'bg_invert', file: `${GUI_PALETTES_DIR}/bg_invert.pcx` },
  { name: 'ingame_remap_01', file: `${GUI_PALETTES_DIR}/ingame_remap_01.pcx` },
  { name: 'ingame_remap_02', file: `${GUI_PALETTES_DIR}/ingame_remap_02.pcx` },
  { name: 'ingame_remap_03', file: `${GUI_PALETTES_DIR}/ingame_remap_03.pcx` },
  { name: 'papyrus', file: `${GUI_PALETTES_DIR}/papyrus.pcx` },
