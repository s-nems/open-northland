 ...
 * `outDir` under its (sanitized) internal path — the documented stage-1 unpack that feeds the
 ...
 * failure (and a missing/unreadable game root) propagates: that's an environmental error, not a
