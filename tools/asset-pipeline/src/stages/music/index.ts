 ...
 * byte evidence: `GameMp.exe` passes the loaded segment to the driver's create-audiopath slot;
 ...
 * passes repeat -1 into the driver's `IDirectMusicSegment8::SetRepeats`), so each track carries two
