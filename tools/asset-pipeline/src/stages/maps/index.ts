 ...
 * name/description sidecar via the folder string tables), `minimap.ts` (the shipped-thumbnail PNG
 * decode), `synth-minimap.ts` (the rasterized thumbnail for folders without one), and
...
export { createMinimapSynthesizer, type MinimapSynthesizerSources } from './synth-minimap.js';
