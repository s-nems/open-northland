...
/**
 * Decodes a map folder's `minimap/minimap.pcx` into the emitted thumbnail PNG, cropped to the map
 * picture. The filler index also occurs as sparse speckles inside the picture, so only the
 * border-connected region is keyed to transparent: a 4-neighbour flood fill from the edges, a named
