...
2. hot-path scaling or unnecessary allocation;
3. mixed responsibilities and overgrown modules;
...
For a readability focus, classify explanatory comments:
...
behavior, reviewer triage, and remaining risk.
