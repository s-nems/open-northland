...
export const customArtRoot = 'packages/app/src/assets/custom/';
...
export function customArtPolicy(catalog, delivery, sharedSources, readJson, isTracked) {
...
/** The repository check's entry: the registered custom art packages and their delivered outputs. */
export function checkoutArtPolicy(readJson, isTracked) {
  return customArtPolicy(
    readJson('docs/art/assets.json'),
    readJson('docs/art/delivery.json'),
    readJson('scripts/custom-art-sources.json'),
    readJson,
    isTracked,
  );
}
