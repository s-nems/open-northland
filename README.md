...
- **Is not:** a binary-faithful re-implementation. Where the original is buggy or unbalanced,
  we fix it. The companion `../research notes` project *is* binary-faithful and we use it
...
(`../Cultures 8th Wonder`). Same model as OpenRA / OpenTTD / research notes. See [`docs/SOURCES.md`](docs/SOURCES.md).
