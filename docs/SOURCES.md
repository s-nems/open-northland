...
| `.cif` | 167 | compiled/encrypted "Cultures Information File" (rules) | `an original routine/CIoHelper.cs`, `SystemHandles/InitGameHandler.cs` |
...
- **Rules are largely declarative.** `Data/logic/` and `DataCnmd/types/` define buildings, jobs,
  ...
  economy, pathfinding) is the hard part and is **not** in the data nor reversed in research notes.
