"""Shared straight-roof geometry for consistent house-A multiview references."""
...
bpy.ops.object.camera_add();cam=bpy.context.object;cam.data.type='ORTHO';cam.data.ortho_scale=7.6;scene.camera=cam
