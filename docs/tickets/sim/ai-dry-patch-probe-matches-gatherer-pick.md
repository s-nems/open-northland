...
real-map run measured 3-25 falsely counted blocked deposits per collector, although it did not
...
An AI-module test leaves only ineligible nodes and requires flag relocation. That test is the gate;
