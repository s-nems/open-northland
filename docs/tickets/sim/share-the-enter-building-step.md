...
The reason this is worth more than the usual dedup: `Resting` has subtle ownership rules that every
call site has to get right independently, and one of them already got it wrong. The marker means
