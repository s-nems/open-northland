...
gated-vs-searched split is carried by a multi-line prose comment instead of structure. Adding the
next delivery rule means picking a letter suffix and re-reading the whole chain for ordering
hazards.
