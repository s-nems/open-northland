...
`data/hud/model.ts` `buildHud` fully rebuilds the HUD model every call — it builds two
...
a real input change. Unblocked: the model/layout/place split it waited on landed
2026-07-17 (`data/hud/{model,layout,place}.ts`).
