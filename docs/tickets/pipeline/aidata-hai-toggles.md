...
script's `SetExternalFlag` raises for it already land in `components/ai-flags.ts`, unread. That integration belongs to
[authored AI conditions](../features/map-scripts-ai-conditions.md).
