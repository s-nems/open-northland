...
2. `research notes` remap machinery — `an original routine/CRemapTable.cs` and the `.hlt`
...
- Investigation findings carry named evidence (file + symbol in research notes, or decoded-data proof,
